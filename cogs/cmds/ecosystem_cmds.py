...
class EcosystemCmds(commands.Cog):
    ...
    async def transfer(self, ctx, member: discord.Member, amount: int):
        ...
        try:
            ...
            await ctx.send(f"You or the person you want to transfer to does not have a account. Please collect your daily money with {self.client.command_prefix(self.client, ctx)[2]}daily. This will also create an account if you do not have one.")
